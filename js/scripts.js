...
$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Clare and Jared's Wedding",

            // Event start date
            start: new Date('October 7, 2023 17:00'),
            ...
            end: new Date('October 7, 2023 17:00'),

            // Event Address
            address: '1250 E. Harvard RD. Burbank, CA 91510-1096 ',
    ...
    $('#add-person').click(
        function () {
            $('#add-person').before("<div id=\"guest-" + addGuestCounter+ "\"> <div class=\"row\"> <div class=\"col-md-6 col-sm-6\"> <div class=\"form-input-group\"> <i class=\"fa fa-user\"><\/i><input name=\"first_name\" class=\"\"  style=\"color: rgba(28, 54, 83, 0.6);\" placeholder=\"First name\" required> <\/div> <\/div> <div class=\"col-md-6 col-sm-6\"> <div class=\"form-input-group\"> <i class=\"fa fa-user\"><\/i><input name=\"last_name\" class=\"\" style=\"color: rgba(28, 54, 83, 0.6);\" placeholder=\"Last name\" required> <\/div> <\/div> <\/div> <div class=\"row\"> <div class=\"col-md-6 col-sm-6\"> <div class=\"form-input-group\"> <i class=\"fa fa-cutlery\"><\/i> <select class=\"form-control\" name=\"meal\" id=\"meal\" form=\"rsvp-form\" required> <option selected disabled value=\"\">Meal Choice<\/option> <option value=\"chicken\">Chicken<\/option> <option value=\"tofu\">Tofu<\/option> <option value=\"nuggets\">Children's Chicken Nuggets<\/option> <\/select> <\/div> <\/div> <div class=\"col-md-6 col-sm-6\"> <a onClick=\"removePerson(\'guest-" + addGuestCounter+ "\')\"><b>Remove This Person <\/b><\/a> <\/div> <\/div> <\/div>")
            addGuestCounter += 1;
    ...
    $(document).on("click", ":submit", function(e) {
        ...
        if ($('#rsvp-form')[0][2].value.toLowerCase() === 'meal choice') {
            ...
            $.post('https://script.google.com/macros/s/AKfycbx5QPU0_FBIAs0f-LL9EYghhrA5xFFHm2r5m7z9FrXqgGk6CeBQ2k_fOuxmiA3-6DAV/exec', data)
                .done(function (data) {
                    console.log(data);
                    if (data.result === "error") {
                        ...
                        if (
                            ...
                            || ($('#rsvp-form')[0][2].value.toLowerCase().trim().indexOf("thomas") > -1 && $('#rsvp-form')[0][3].value.toLowerCase().trim().indexOf("yamamoto") > -1)
                            ...
                            || ($('#rsvp-form')[0][2].value.toLowerCase().trim().indexOf("esther") > -1 && $('#rsvp-form')[0][3].value.toLowerCase().trim().indexOf("chu") > -1)
